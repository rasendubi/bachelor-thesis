...
\def\simpleGrad{\sl\small\noindent\hbox to 0pt{%
    \vbox to 0pt{%
      ...
      \put(0,0){\Box{7mm}{\GostB Змн.}}
      \put(0,15)\HL
      \put(0,5){\line(1,0){65}}
      \linethickness{0.3mm}
      \put(0,10){\line(1,0){65}}
      \linethickness{0.5mm}
      \put(7,0){\VL\Box{10mm}{\GostB Арк.}}
      \put(17,0){\VL\Box{23mm}{\GostB \No~докум.}}
      \put(40,0){\VL\Box{15mm}{\GostB Підпис}}
      \put(55,0){\VL\Box{10mm}{\GostB Дата}}
      \put(65,0){\VL\makebox(110,15){\large\sc\GostB БЛА.20123.2342.ПЗ}}
      \put(175,10){\Box{10mm}{\GostB Арк.}}
...
\lhead{ \fancyplain{left}{\simpleGrad} }
